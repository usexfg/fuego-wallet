          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Fuego Ξmbers (HEAT) are the atomic equivalent ERC20 token of XFG minted on Ethereum L1 using Arbitrum L2 for gas-efficiency (verifying STARKs is thirsty work).',
                    style: TextStyle(
