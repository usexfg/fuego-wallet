              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildInterestCard(
                    title: '3 Months',
                    rate: '8%',
                    description: 'Minimum term deposit',
                  ...
                  _buildInterestCard(
                    title: '6 Months',
                    rate: '12%',
                    description: 'Medium-term deposit',
                    example: '800 XFG @ 12% = 0.00096 CD yield',
                  ),
                  const SizedBox(height: 12),
                  _buildInterestCard(
                    title: '1 Year',
                    ...
                    example: '800 XFG @ 21% = 0.00168 CD yield',
                  ),
                  const SizedBox(height: 12),
                  _buildInterestCard(
                    title: '9 Months',
                    rate: '18%',
                    description: 'Extended medium-term',
                  ...
                  _buildInterestCard(
                    title: '3 Years',
                    rate: '33%',
                    description: 'Long-term deposit',
                    example: '800 XFG @ 33% = 0.00264 CD yield',
                  ),
